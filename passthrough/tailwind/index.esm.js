    ...
    column: {
      headercell: function headercell(_ref170) {
        var context = _ref170.context,
          props = _ref170.props;
        return {
          className: classNames('text-left border-0 border-b border-solid border-gray-300 dark:border-blue-900/40 font-bold', 'transition duration-200', context.size === 'small' ? 'p-2' : context.size === 'large' ? 'p-5' : 'p-4',
          // Size
      ...
      bodycell: function bodycell(_ref171) {
        ...
        return {
          className: classNames('text-left border-0 border-b border-solid border-gray-300', context.size === 'small' ? 'p-2' : context.size === 'large' ? 'p-5' : 'p-4',
          // Size
      ...
      footercell: function footercell(_ref172) {
        ...
        return {
          className: classNames('text-left border-0 border-b border-solid border-gray-300 font-bold', 'bg-slate-50 text-slate-700', 'transition duration-200', context.size === 'small' ? 'p-2' : context.size === 'large' ? 'p-5' : 'p-4',
          // Size
      ...
      filterrowitem: function filterrowitem(_ref174) {
        ...
        return {
          className: classNames('m-0 py-3 px-5 bg-transparent', 'transition duration-200', context.highlighted ? 'text-blue-700 bg-blue-100 dark:text-white/80 dark:bg-blue-300' : 'text-gray-600 bg-transparent dark:text-white/80 dark:bg-transparent')
        };
      },
      filteroperator: {
