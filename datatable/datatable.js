  ...
  var DataTable = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var createResponsiveStyle = function createResponsiveStyle() {
      if (!responsiveStyleElement.current) {
        ...
        var tableSelector = "[data-pc-section=\"wrapper\"] ".concat(isVirtualScrollerDisabled() ? '' : '> [data-pc-name="virtualscroller"]', " > [data-pc-section=\"table\"]");
        var selector = "[data-pc-name=\"datatable\"][".concat(attributeSelector.current, "] > ").concat(tableSelector);
        var gridLinesSelector = "[data-pc-name=\"datatable\"][".concat(attributeSelector.current, "][data-showgridlines=\"true\"] > ").concat(tableSelector);
        var innerHTML = "\n@media screen and (max-width: ".concat(props.breakpoint, ") {\n    ").concat(selector, " > [data-pc-section=\"thead\"] > tr > th,\n    ").concat(selector, " > [data-pc-section=\"tfoot\"] > tr > td {\n        display: none;\n    }\n\n    ").concat(selector, " > [data-pc-section=\"tbody\"] > tr > td {\n        display: flex;\n        width: 100%;\n        align-items: center;\n        justify-content: space-between;\n    }\n\n    ").concat(selector, " > [data-pc-section=\"tbody\"] > tr > td:not(:last-child) {\n        border: 0 none;\n    }\n\n    ").concat(gridLinesSelector, " > [data-pc-section=\"tbody\"] > tr > td:last-child {\n        border-top: 0;\n        border-right: 0;\n        border-left: 0;\n    }\n\n    ").concat(selector, " > [data-pc-section=\"tbody\"] > tr > td > [data-pc-section=\"columntitle\"] {\n        display: block;\n    }\n}\n");
